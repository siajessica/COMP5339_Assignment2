# Data Engineering Assignment 2 - Group 84

## File Structure 

- publisher.py: includes functions for data integration, data cleaning, and MQTT Publisher
- app.py: includes functions for MQTT Subscribing and data visualisation
